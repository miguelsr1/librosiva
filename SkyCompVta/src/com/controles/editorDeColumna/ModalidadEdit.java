...
import com.servicio.ServModalidad;
 ...
 * @author misanchez
 */
public class ModalidadEdit extends JComboBox implements TableCellEditor{
    private LinkedList suscriptores = new LinkedList();
    
    public ModalidadEdit(){
        super();
        ...
        this.setListado(ServModalidad.getListado());
